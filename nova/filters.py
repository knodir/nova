...
class BaseFilterHandler(loadables.BaseLoader):
    ...
    def get_filtered_objects(self, filters, objs, spec_obj, index=0):
        ...
        benchmark.add_benchmark(spec_obj.get_req_id(), spec_obj.get_vm_name(), "nova.scheduler.filtering.start", spec_obj.get_vm_name() == "vm_flush")
        ...
        benchmark.add_benchmark(spec_obj.get_req_id(), spec_obj.get_vm_name(), "nova.scheduler.filtering.end", spec_obj.get_vm_name() == "vm_flush")
