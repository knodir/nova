...
class ComputeTaskManager(base.Base):
    ...
    def schedule_and_build_instances(self, context, build_requests,
                                     ...
                                     tags=None):
        benchmark.add_benchmark(context.request_id, context.get_vm_name(), "nova.conductor.start", context.get_vm_name() == "vm_flush")
        ...
        for (build_request, request_spec, host_list, instance) in zipped:
            ...
            with obj_target_cell(instance, cell) as cctxt:
                self.compute_rpcapi.build_and_run_instance(
                    ...
                    limits=host.limits, host_list=host_list)
        benchmark.add_benchmark(context.request_id, context.get_vm_name(), "nova.conductor.end", context.get_vm_name() == "vm_flush")
